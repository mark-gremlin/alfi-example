package com.gremlindemo.alfiexample.functionaltest;
...
public class BasicAuthVerificationFunctionalTest {
    ...
    public void verify_call_works_with_valid_basic_auth_header() {
        String fullUrl = props.alfiexampleHost + ExampleBasicAuthProtectedEndpoint.MATCHING_PATH;
    ...
    public void healthcheck_call_should_not_require_basic_auth() {
        String fullUrl = props.alfiexampleHost + "/healthcheck";
