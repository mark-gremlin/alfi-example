...
import static com.gremlindemo.alfiexample.error.ProjectApiError.EXAMPLE_EMBEDDED_CASSANDRA_DISABLED;
...
public class ExampleCassandraAsyncEndpoint extends StandardEndpoint<Void, String> {
    ...
    public @NotNull CompletableFuture<ResponseInfo<String>> execute(
        ...
        gremlinService.applyImpact(new TrafficCoordinates.Builder()
                .withType(this.getClass().getSimpleName()).withField("method", "execute").build());
